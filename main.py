...
if __name__ == '__main__':
    ...
    if args.phase == "train_imitator":
    ...
    elif args.phase == "train_inverter":
        ...
        if cuda:
            inverter.cuda()
        inverter.evaluate_model(cuda)
    elif args.phase == "train_cycleim":
        log.info('cycle imitator train mode')
